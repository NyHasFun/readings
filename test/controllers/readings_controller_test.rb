...
class ReadingsControllerTest < ActionController::TestCase
  ...
  test "should create reading" do
    assert_difference('Reading.count') do
      post :create, reading: { bought: @reading.bought, format: @reading.format, report: @reading.report, start: @reading.start, stop: @reading.stop }
    end
  ...
  test "should update reading" do
    patch :update, id: @reading, reading: { bought: @reading.bought, format: @reading.format, report: @reading.report, start: @reading.start, stop: @reading.stop }
    assert_redirected_to reading_path(assigns(:reading))
  end
